...
#### 3) 미래 위험도 (최대 30점)
- 향후 20년 후 예상두께를 계산  
- 20년 후 허용두께(3.2mm) 이하로 내려갈수록 위험 점수 증가  
...
# --------------------------------------
# 오른쪽: 동일 조건 전기방식 비교 (꺾은선 그래프)
# --------------------------------------
with col_right:
    st.markdown("## ⚡ 전기방식 유무에 따른 부식률 비교")
