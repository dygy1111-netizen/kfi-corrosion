...
# 탭 생성
# =============================
tab_query, tab_analysis = st.tabs(["🔎 조회탭", "📊 분석탭"])
    ...
    with col_mid_left:
        ...
        st.markdown("""
            <style>
                ...
                @media (max-width:768px) {.tbl-dark{width:100%!important; font-size:0.9rem!important;} .tbl-dark th, .tbl-dark td{padding:6px!important;}}
            </style>
...
# =============================
with tab_analysis:
    st.subheader("📊 분석탭 (준비 중)")
    st.caption("여기에 고급 분석/보고서/시뮬레이션 기능을 이어서 붙이면 됩니다.")
    # 예: 추후 사용을 위해 조회탭 상태 가져오기
